...
RSpec.describe AgentRuntime do
  describe AgentRuntime::Error do
  ...
  describe AgentRuntime::PolicyViolation do
  ...
  describe AgentRuntime::UnknownAction do
    it "inherits from Error" do
      expect(described_class.superclass).to eq(AgentRuntime::Error)
    end
  ...
  describe AgentRuntime::ToolNotFound do
    it "inherits from Error" do
      expect(described_class.superclass).to eq(AgentRuntime::Error)
    end
  ...
  describe AgentRuntime::ExecutionError do
    it "inherits from Error" do
      expect(described_class.superclass).to eq(AgentRuntime::Error)
    end
  ...
  describe AgentRuntime::MaxIterationsExceeded do
